...
android {
    namespace = "com.example.alyfy_app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.alyfy_app"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    //add Roulax SDK
//    implementation 'com.roulax.android.sdk:roulax-android-sdk:3.0.0'
    //add OKSpin SDK
//    implementation ("com.okspin.android.sdk:okspin-android-sdk:1.2.1")
